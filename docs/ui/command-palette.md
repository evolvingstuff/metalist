...
- `AI Agent Settings…`: selects the loopback Ollama endpoint and an installed model for standalone chat. Model discovery tests that endpoint when the settings modal opens or refresh is requested.
