...
- `Search suggestion time windows…` edits the ordered personalized slots. Each slot accepts 1–365 calendar days; rows can be added, removed, or reordered, and an empty list disables personalization. The default is 1, 7, and 30 days.
