...
- Engagement deduplication applies only while remaining in the same active tab and executed-search context. Leaving that context and later returning starts a fresh flow.
