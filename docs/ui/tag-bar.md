...
- While the single-note tag bar is focused, note-level edit shortcuts still target the current note, including create sibling/child, delete, move up/down, move to top, indent/outdent, join, split, unformat, note copy/cut/paste, and the password modal shortcut.
