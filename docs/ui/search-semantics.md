...
- Clicking a redacted placeholder reveals only that one note locally in the current tab; it stays visually dimmed so excluded search context is still obvious.
