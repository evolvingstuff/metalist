...
- Windows/Python 3.13 repeats Chrome, Firefox, and Edge after the standalone repair upgrade. This verifies the affected Windows Chrome path against the upgraded installed application rather than treating an Edge result as a substitute.
