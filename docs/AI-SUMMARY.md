...
- Edit focus styling: `app/static/css/main.css` uses `#notes-container:has(.note.editing)` to slightly blur every non-editing note's immediate content/toggle, including ancestor content, while keeping the edited note sharp.
