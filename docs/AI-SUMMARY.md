...
- Suggestion behavior: search-bar and tag-bar suggestions are segment-aware for connector-separated tags, collapse case-equivalent tags to one displayed spelling, and tag-bar suggestions can content-match or prefix-complete ontology tags that have never been explicitly used on a note; actual search filtering remains exact on effective tag terms.
