...
def test_save_client_preferences_accepts_ai_configuration(memory_settings_db) -> None:
    ...
    expected_preferences = {
        ...
        "pref.ai.retrieval.ideal_narrowed_scope_approximate_tokens": "200000",
        ...
        "pref.ai.openai.retrieval.max_page_approximate_tokens": "250000",
        "pref.ai.openai.retrieval.max_ranked_tags_per_page": "125",
        "pref.ai.openai.retrieval.max_working_summary_characters": "24000",
        "pref.ai.openai.retrieval.ideal_narrowed_scope_approximate_tokens": "500000",
        ...
        "pref.ai.skill.scoped_investigation_v2": "Old flat investigation skill",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("pref.ai.retrieval.max_ranked_tags_per_page", "0"),
        ...
        ("pref.ai.openai.retrieval.max_page_approximate_tokens", "250001"),
        ("pref.ai.retrieval.ideal_narrowed_scope_approximate_tokens", "200001"),
        ("pref.ai.openai.retrieval.ideal_narrowed_scope_approximate_tokens", "500001"),
    ],
)
